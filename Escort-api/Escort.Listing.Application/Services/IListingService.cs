...
public interface IListingService
{
    ...
    Task<Domain.Models.Listing> CreateAsync(Domain.Models.ListingDetails listingDetails, Guid userId);
    Task<Domain.Models.Listing> UpdateAsync(Domain.Models.ListingDetails listingDetails, Guid userId);
